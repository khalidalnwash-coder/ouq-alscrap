...
const MOTORCYCLE_MAKES = [
  ...
  'لِفان', 'سي إف موتو',
  'أبريليا', 'بنيلي', 'إندين', 'MV أغوستا', 'هوسكفارنا',
  'فيسبا', 'هيرو', 'باجاج',
  'زيرو', // electric
  'أخرى',
];
const MOTORCYCLE_MODELS_BY_MAKE = {
  ...
  'أبريليا': ['RS 660', 'Tuono 660', 'RSV4', 'Tuareg 660', 'أخرى'],
  'بنيلي': ['TRK 502', 'Leoncino 500', '302R', 'TNT 600i', 'أخرى'],
  'إندين': ['Scout', 'Chief', 'Chieftain', 'Springfield', 'أخرى'],
  'MV أغوستا': ['Brutale', 'F3', 'Dragster', 'Turismo Veloce', 'أخرى'],
  'هوسكفارنا': ['Vitpilen 401', 'Svartpilen 401', 'Norden 901', 'أخرى'],
  'فيسبا': ['Primavera', 'GTS 300', 'Sprint', 'أخرى'],
  'هيرو': ['Splendor', 'HF Deluxe', 'Xtreme 160R', 'Glamour', 'أخرى'],
  'باجاج': ['Pulsar', 'Dominar 400', 'Avenger', 'Platina', 'أخرى'],
  'زيرو': ['SR/F', 'DSR', 'FXE', 'S', 'أخرى'],
};

const CAR_MAKES = [
  'تويوتا', 'نيسان', 'هيونداي', 'كيا', 'مرسيدس-بنز', 'بي إم دبليو',
  'لكزس', 'فورد', 'شيفروليه', 'جي إم سي', 'هوندا', 'ميتسوبيشي',
  'أودي', 'فولكس فاجن', 'بورش', 'لاند روفر', 'جاكوار', 'مازدا',
  'سوبارو', 'بيجو', 'رينو', 'جيب', 'دودج', 'كرايسلر', 'رام',
  'كاديلاك', 'لينكولن', 'إنفينيتي', 'ميني', 'فولفو', 'سكودا', 'سوزوكي',
  'جيلي', 'إم جي', 'شانجان', 'جاك', 'هافال', 'بايك',
  'شيري', 'جي إيه سي', 'جيتور', 'أومودا',
  'تسلا', 'لوسيد', 'بي واي دي', // electric
  'أخرى',
];
const CAR_MODELS_BY_MAKE = {
  ...
  'أودي': ['A3', 'A4', 'A6', 'Q3', 'Q5', 'Q7', 'Q8', 'أخرى'],
  'فولكس فاجن': ['جولف', 'باسات', 'تيغوان', 'طوارق', 'أطلس', 'أخرى'],
  'بورش': ['911', 'كايان', 'ماكان', 'باناميرا', 'تايكان', 'أخرى'],
  'لاند روفر': ['ديفندر', 'ديسكفري', 'رينج روفر', 'رينج روفر سبورت', 'إيفوك', 'أخرى'],
  'جاكوار': ['XE', 'XF', 'F-Pace', 'E-Pace', 'F-Type', 'أخرى'],
  'مازدا': ['مازدا 3', 'مازدا 6', 'CX-5', 'CX-9', 'CX-30', 'أخرى'],
  'سوبارو': ['فورستر', 'أوتباك', 'إمبريزا', 'إكس في', 'أخرى'],
  'بيجو': ['208', '308', '508', '2008', '3008', '5008', 'أخرى'],
  'رينو': ['داستر', 'كوليوس', 'ميغان', 'كادجار', 'أخرى'],
  'جيب': ['رانجلر', 'جراند شيروكي', 'شيروكي', 'كومباس', 'أخرى'],
  'دودج': ['تشارجر', 'تشالنجر', 'دورانجو', 'أخرى'],
  'كرايسلر': ['300', 'باسيفيكا', 'أخرى'],
  'رام': ['1500', '2500', '3500', 'أخرى'],
  'كاديلاك': ['إسكاليد', 'CT5', 'XT5', 'XT6', 'أخرى'],
  'لينكولن': ['نافيجيتور', 'أفياتور', 'كورسير', 'أخرى'],
  'إنفينيتي': ['Q50', 'QX60', 'QX80', 'QX50', 'أخرى'],
  'ميني': ['كوبر', 'كونتري مان', 'كلوب مان', 'أخرى'],
  'فولفو': ['XC40', 'XC60', 'XC90', 'S60', 'S90', 'أخرى'],
  'سكودا': ['أوكتافيا', 'كودياك', 'كاروك', 'سوبيرب', 'أخرى'],
  ...
  'شيري': ['تيجو 4', 'تيجو 7', 'تيجو 8', 'أرايزو 6', 'أخرى'],
  'جي إيه سي': ['GS3', 'GS8', 'إمكوو', 'أخرى'],
  'جيتور': ['X70', 'X90', 'دشينج', 'أخرى'],
  'أومودا': ['C5', 'C7', 'أخرى'],
  'تسلا': ['Model 3', 'Model Y', 'Model S', 'Model X', 'أخرى'],
  'لوسيد': ['Air', 'Gravity', 'أخرى'],
  'بي واي دي': ['هان', 'تانج', 'أتو 3', 'سيل', 'أخرى'],
};
...
const TRUCK_MAKES = [
  ...
  'فوتون', 'دونغفنغ',
  'كينورث', 'بيترربيلت', 'إنترناشيونال',
  'تاتا', 'أشوك ليلاند', 'شاكمان', 'هيونداي', 'رينو',
  'تسلا', 'بي واي دي', // electric
  'أخرى',
];
const TRUCK_MODELS_BY_MAKE = {
  ...
  'كينورث': ['T680', 'T880', 'W900', 'أخرى'],
  'بيترربيلت': ['389', '579', '567', 'أخرى'],
  'إنترناشيونال': ['LT', 'HX', 'MV', 'أخرى'],
  'تاتا': ['LPT 1613', 'LPT 2518', 'برايما', 'أخرى'],
  'أشوك ليلاند': ['بوس', 'كابتن', 'يو-تراك', 'أخرى'],
  'شاكمان': ['X3000', 'X6000', 'F3000', 'أخرى'],
  'هيونداي': ['مايتي', 'إكسيينت', 'أخرى'],
  'رينو': ['رينو تي', 'رينو كي', 'رينو دي', 'أخرى'],
  'تسلا': ['Semi', 'أخرى'],
  'بي واي دي': ['T5', 'T7', 'T9', 'أخرى'],
};
